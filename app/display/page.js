  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white flex flex-col items-center justify-between p-8 md:p-16 select-none overflow-hidden">
      ...
      <div className="w-full max-w-6xl my-auto py-8">
        ...
        {status === 'answer-reveal' && answerBreakdown && answerBreakdown.gameType !== 'shot-in-the-dark' && answerBreakdown.gameType !== 'simon-says' && answerBreakdown.gameType !== 'autocomplete-trivia' && answerBreakdown.gameType !== 'word-scramble' && answerBreakdown.gameType !== 'pitch-meeting' && answerBreakdown.gameType !== 'timeline' && (
